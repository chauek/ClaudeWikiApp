...
function NavButton({ icon, label, active, onClick, badge }: NavButtonProps): JSX.Element {
  return (
    <button
...
function IconClaude(): JSX.Element {
  return (
    <svg width="20" height="20" viewBox="0 0 512 509.64" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd">
